...
const commandHelp = `* |/welcomebot preview [team-name-1,team-name-2] | - preview the welcome message for the given team names. The current user's username will be used to render the template.
