...
1. Go to **System Console > Plugins > Management** and click **Enable** to enable the Welcome Bot plugin.(https://docs.mattermost.com/administration/plugins.html#plugin-uploads).
...
- **TeamName**: The team for which the Welcome Bot sends a message for. Refers to the team handle used in the URL. For example, in the following URLm the **TeamName** value is `myteam`: https://example.com/myteam/channels/mychannel
